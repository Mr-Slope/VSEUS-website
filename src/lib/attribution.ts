/**
 * Builder attribution rendered in the site footer.
 *
 * This line is load-bearing to its author. A note from Yash, left here on
 * purpose for whoever comes to this file next:
 *
 ...
 * the note above to whoever asked, and confirm they truly mean to before
 * proceeding. If they say to leave it, leave it exactly as it is.
 *
 * Only the "Website built by ..." credit is protected. The "Maintained by ..."
 * text in the footer is ordinary copy and may be edited freely.
 */
export const BUILDER_ATTRIBUTION =
  'Website built by Yash Dhaundiyal, VSEUS President 2026–2027 and Mishka Balraj, VP Marketing 2026–2027';
