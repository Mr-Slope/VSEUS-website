      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-navy-100 p-8">
          <div className="text-center mb-7">
            ...
            <p className="text-sm text-gray-500 mt-1">Sign in to your member portal</p>
          </div>
          ...
          <button
            ...
            onClick={() => setError('Google sign-in will be available once Firebase is connected.')}
          >
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            New to VSEUS?{' '}
            <Link href="/auth/signup" className="text-navy-500 font-semibold hover:text-navy-700">
              Create an account
            </Link>
          </p>
