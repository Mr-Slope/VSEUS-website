...
const totalRegistrations = MOCK_EVENTS.reduce((sum, e) => sum + e.registeredCount, 0);
    ...
    <div className="p-6 lg:p-8 max-w-4xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        {[
          ...
          { label: 'Paid Events', value: MOCK_EVENTS.filter((e) => e.isPaid).length },
        ].map((s) => (
      ...
      <div className="bg-white rounded-2xl border border-navy-100 overflow-hidden mb-6">
        ...
        <div className="divide-y divide-navy-100">
          {MOCK_EVENTS.map((e) => {
            const pct = e.capacity ? Math.round((e.registeredCount / e.capacity) * 100) : null;
            return (
