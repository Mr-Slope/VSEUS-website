...
const pillars = [
  {
    ...
    description: 'Tutoring resources (ELC), course guides, and research opportunities to help you excel in your economics degree.',
  ...
  },
  {
    ...
    description: 'Representing economics students at the AMS, university committees, advocating for program improvements, and amplifying student voices.',
